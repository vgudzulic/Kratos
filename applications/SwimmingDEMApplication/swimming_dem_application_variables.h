...
namespace Kratos {
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(SWIMMING_DEM_APPLICATION, double, SOLID_FRACTION_BED)
    KRATOS_DEFINE_APPLICATION_VARIABLE(SWIMMING_DEM_APPLICATION, double, MIN_FLUID_FRACTION_PROJECTED)
    KRATOS_DEFINE_APPLICATION_VARIABLE(SWIMMING_DEM_APPLICATION, double, MAX_STEADY_STEPS)
