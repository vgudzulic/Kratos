    ...
    )
{
    ...
    KRATOS_ERROR_IF_NOT(rMaterialProperties[ORTHOTROPIC_ELASTIC_CONSTANTS].size() == 6) << "The dimension of the ORTHOTROPIC_ELASTIC_CONSTANTS is incorrect: " << rMaterialProperties[ORTHOTROPIC_ELASTIC_CONSTANTS].size() << " vs 6" << std::endl;
