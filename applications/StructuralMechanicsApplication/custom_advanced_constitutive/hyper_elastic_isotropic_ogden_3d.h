...
#if !defined (KRATOS_HYPER_ELASTIC_ISOTROPIC_OGDEN_3D_LAW_H_INCLUDED)
#define  KRATOS_HYPER_ELASTIC_ISOTROPIC_OGDEN_3D_LAW_H_INCLUDED
 ...
 * @brief This law defines an hyperelastic material according to the Ogden formulation for 3D cases
 * @details see https://royalsocietypublishing.org/doi/abs/10.1098/rspa.1972.0026
 * @author Alejandro Cornejo
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) HyperElasticIsotropicOgden3D
...
public:
     ...
     * Copy constructor.
     */
    HyperElasticIsotropicOgden3D (const HyperElasticIsotropicOgden3D& rOther);

    /**
     * Destructor.
     */
    ~HyperElasticIsotropicOgden3D() override;
