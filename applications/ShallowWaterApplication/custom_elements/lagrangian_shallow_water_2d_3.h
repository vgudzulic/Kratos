...
#ifndef KRATOS_LAGRANGIAN_SHALLOW_WATER_2D_3_H_INLCUDED
#define KRATOS_LAGRANGIAN_SHALLOW_WATER_2D_3_H_INLCUDED
...
class LagrangianShallowWater2D3 : public Element
{
public:
    ...
    struct ElementData
    {
        ...
        array_1d<double, 3> pressure_a;

        array_1d<double, 9> unknown;
        array_1d<double, 9> prev_unk;

        ElementData(const ProcessInfo& rCurrentProcessInfo);
        void GetNodalData(const GeometryType& rGeometry, const BoundedMatrix<double,3,2>& rDN_DX);
    };

    ///@}
    ///@name Pointer Definitions
    /// Pointer definition of LagrangianShallowWater2D3
    KRATOS_CLASS_POINTER_DEFINITION(LagrangianShallowWater2D3);
     ...
     * Constructor.
     */
    LagrangianShallowWater2D3(IndexType NewId = 0)
    : Element(NewId)
    {}
     ...
     */
    LagrangianShallowWater2D3(IndexType NewId, const NodesArrayType& ThisNodes)
     ...
     */
    LagrangianShallowWater2D3(IndexType NewId, GeometryType::Pointer pGeometry)
     ...
     */
    LagrangianShallowWater2D3(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
    ...
    {
        return Kratos::make_intrusive<LagrangianShallowWater2D3>(NewId, GetGeometry().Create(ThisNodes), pProperties);
    }
    ...
    Element::Pointer Create(
        ...
        PropertiesType::Pointer pProperties) const override
    {
        return Kratos::make_intrusive<LagrangianShallowWater2D3>(NewId, pGeom, pProperties);
    }
    ...
    {
        Element::Pointer p_new_elem = Kratos::make_intrusive<LagrangianShallowWater2D3>(NewId, GetGeometry().Create(ThisNodes), pGetProperties());
...
}; // Class LagrangianShallowWater2D3
...
#endif // KRATOS_LAGRANGIAN_SHALLOW_WATER_2D_3_H_INLCUDED  defined
