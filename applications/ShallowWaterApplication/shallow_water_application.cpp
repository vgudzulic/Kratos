...
namespace Kratos
{
    ...
    KratosShallowWaterApplication::KratosShallowWaterApplication():
        ...
        mLagrangianShallowWater2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3>>(Element::GeometryType::PointsArrayType(3)))),
    ...
    void KratosShallowWaterApplication::Register()
    {
        ...
        KRATOS_REGISTER_ELEMENT("LagrangianShallowWater2D3N", mLagrangianShallowWater2D3N)
