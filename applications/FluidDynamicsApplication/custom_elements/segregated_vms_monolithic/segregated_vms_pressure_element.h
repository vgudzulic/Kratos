...
#if !defined(KRATOS_SEGREGATED_VMS_PRESSURE_ELEMENT_H_INCLUDED)
#define KRATOS_SEGREGATED_VMS_PRESSURE_ELEMENT_H_INCLUDED
...
class SegregatedVMSPressureElement : public Element
{
public:
    ///@name Type Definitions
    ///@{
    /// Pointer definition of SegregatedVMSPressureElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(SegregatedVMSPressureElement);

    /// definition of base type
    using BaseType = Element;

    /// definition of element type
    using ElementType = SegregatedVMSPressureElement;
    ...
    static constexpr IndexType LocalSize = TNumNodes;
    ///@}
     ...
     * Constructor.
     */
    explicit SegregatedVMSPressureElement(IndexType NewId = 0) : BaseType(NewId)
    {
    }
     ...
     */
    SegregatedVMSPressureElement(IndexType NewId, const NodesArrayType& ThisNodes)
     ...
     */
    SegregatedVMSPressureElement(IndexType NewId, GeometryType::Pointer pGeometry)
     ...
     */
    SegregatedVMSPressureElement(IndexType NewId,
    ...
    SegregatedVMSPressureElement(SegregatedVMSPressureElement const& rOther)
        : BaseType(rOther)
    {
    }
    ...
    ~SegregatedVMSPressureElement() override = default;
    ...
    SegregatedVMSPressureElement& operator=(SegregatedVMSPressureElement const& rOther)
    {
    ...
    {
        return Kratos::make_intrusive<SegregatedVMSPressureElement>(
    ...
    Element::Pointer Create(IndexType NewId,
                            ...
                            PropertiesType::Pointer pProperties) const override
    {
        return Kratos::make_intrusive<SegregatedVMSPressureElement>(NewId, pGeom, pProperties);
    }
    ...
    {
        SegregatedVMSPressureElement::Pointer p_new_elem =
            Kratos::make_intrusive<SegregatedVMSPressureElement>(
    ...
    std::string Info() const override
    {
        ...
        buffer << "SegregatedVMSPressureElement #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "SegregatedVMSPressureElement #" << Id();
    }
...
}; // Class SegregatedVMSPressureElement
...
inline std::istream& operator>>(std::istream& rIStream,
                                SegregatedVMSPressureElement<TDim, TNumNodes>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator<<(std::ostream& rOStream,
                                const SegregatedVMSPressureElement<TDim, TNumNodes>& rThis)
{
...
#endif // KRATOS_SEGREGATED_VMS_PRESSURE_ELEMENT_H_INCLUDED  defined
