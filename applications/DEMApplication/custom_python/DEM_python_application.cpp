...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_ROTATIONAL_DAMPING)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INERTIAL_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_AUX_MASS)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_ROTATIONAL_AUX_MASS)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, AUX_DISPLACEMENT)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, AUX_ROTATION)
}
