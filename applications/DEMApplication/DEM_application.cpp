...
KRATOS_CREATE_VARIABLE(double, NODAL_ROTATIONAL_DAMPING)
KRATOS_CREATE_VARIABLE(double, INERTIAL_FACTOR)
KRATOS_CREATE_VARIABLE(double, NODAL_AUX_MASS)
KRATOS_CREATE_VARIABLE(double, NODAL_ROTATIONAL_AUX_MASS)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(AUX_DISPLACEMENT)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(AUX_ROTATION)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(NODAL_ROTATIONAL_DAMPING)
    KRATOS_REGISTER_VARIABLE(INERTIAL_FACTOR)
    KRATOS_REGISTER_VARIABLE(NODAL_AUX_MASS)
    KRATOS_REGISTER_VARIABLE(NODAL_ROTATIONAL_AUX_MASS)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(AUX_DISPLACEMENT)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(AUX_ROTATION)
