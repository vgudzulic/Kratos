...
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, STABILIZATION_SCALING_FACTOR)
...
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, RESIDUAL)
