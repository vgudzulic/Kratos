...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowVelocity2D3N_EquationIdVector,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
    ...
    // Test:
    RansModellingApplicationTestUtilities::TestEquationIdVector<ModelPart::ElementsContainerType>(
        r_model_part);
}
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowPressure2D3N_EquationIdVector,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
