...
namespace
{
ModelPart& RansEvmKOmegaKResidualBasedFC2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKOmegaTestUtilities::RansEvmKOmegaK2D3N_SetUp(
        rModel, "RansEvmKOmegaKResidualBasedFC2D3N");
...
ModelPart& RansEvmKOmegaOmegaResidualBasedFC2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKOmegaTestUtilities::RansEvmKOmegaOmega2D3N_SetUp(
        rModel, "RansEvmKOmegaOmegaResidualBasedFC2D3N");
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKResidualBasedFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKResidualBasedFC2D3N_SetUp(model);

    // Test:
    RansModellingApplicationTestUtilities::TestEquationIdVector<ModelPart::ElementsContainerType>(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKResidualBasedFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKResidualBasedFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKResidualBasedFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKResidualBasedFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKResidualBasedFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaKResidualBasedFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaResidualBasedFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaResidualBasedFC2D3N_SetUp(model);

    // Test:
    RansModellingApplicationTestUtilities::TestEquationIdVector<ModelPart::ElementsContainerType>(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaResidualBasedFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaResidualBasedFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaResidualBasedFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaResidualBasedFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaResidualBasedFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaOmegaResidualBasedFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaOmegaResidualBasedFC2D3N_SetUp(model);
