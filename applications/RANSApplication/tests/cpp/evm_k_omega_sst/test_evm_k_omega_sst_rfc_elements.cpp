...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKResidualBasedFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKResidualBasedFC2D3N_SetUp(model);

    // Test:
    RansModellingApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKResidualBasedFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKResidualBasedFC2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKResidualBasedFC2D3N_CalculateRightHandSide, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKResidualBasedFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKResidualBasedFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTKResidualBasedFC2D3N_CalculateDampingMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTKResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_SetUp(model);

    // Test:
    RansModellingApplicationTestUtilities::TestEquationIdVector(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_CalculateLocalSystem,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_CalculateRightHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKOmegaSSTOmegaResidualBasedFC2D3N_CalculateDampingMatrix,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
