...
namespace
{
ModelPart& RansIncompressiblePotentialFlowVelocity2D2N_SetUp(Model& rModel)
{
    ...
    ModelPart& r_model_part = CreateTestModelPart(
        rModel, "Element2D3N", "RansIncompressiblePotentialFlowVelocity2D2N",
...
ModelPart& RansIncompressiblePotentialFlowPressure2D2N_SetUp(Model& rModel)
{
    const auto add_variables_function = [](ModelPart& rModelPart) {
        rModelPart.AddNodalSolutionStepVariable(VELOCITY_POTENTIAL);
    ...
    ModelPart& r_model_part = CreateTestModelPart(
        rModel, "Element2D3N", "RansIncompressiblePotentialFlowPressure2D2N",
        add_variables_function, PRESSURE_POTENTIAL, 1);
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowVelocity2D2N_EquationIdVector,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansIncompressiblePotentialFlowVelocity2D2N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowVelocity2D2N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansIncompressiblePotentialFlowVelocity2D2N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowVelocity2D2N_CalculateLocalSystem,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowVelocity2D2N_CalculateLeftHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowVelocity2D2N_CalculateRightHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowPressure2D2N_EquationIdVector,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansIncompressiblePotentialFlowPressure2D2N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowPressure2D2N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansIncompressiblePotentialFlowPressure2D2N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowPressure2D2N_CalculateLocalSystem,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowPressure2D2N_CalculateLeftHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansIncompressiblePotentialFlowPressure2D2N_CalculateRightHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
