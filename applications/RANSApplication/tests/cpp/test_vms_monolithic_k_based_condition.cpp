...
namespace
{
ModelPart& RansVMSMonolithicKBasedWallCondition2D2N_SetUp(Model& rModel)
{
    ...
    ModelPart& r_model_part = CreateTestModelPart(
        rModel, "Element2D3N", "RansVMSMonolithicKBasedWallCondition2D2N",
        add_variables_function, 1);
...
KRATOS_TEST_CASE_IN_SUITE(RansVMSMonolithicKBasedWallCondition2D2N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansVMSMonolithicKBasedWallCondition2D2N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansVMSMonolithicKBasedWallCondition2D2N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansVMSMonolithicKBasedWallCondition2D2N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansVMSMonolithicKBasedWallCondition2D2N_CalculateLocalSystem,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansVMSMonolithicKBasedWallCondition2D2N_CalculateLeftHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansVMSMonolithicKBasedWallCondition2D2N_CalculateRightHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansVMSMonolithicKBasedWallCondition2D2N_CalculateDampingMatrix,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
