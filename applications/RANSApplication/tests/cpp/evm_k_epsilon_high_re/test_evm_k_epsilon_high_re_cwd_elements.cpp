...
namespace
{
ModelPart& RansEvmKEpsilonKCrossWindStabilized2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKEpsilonHighReTestUtilities::RansEvmKEpsilonK2D3N_SetUp(
        rModel, "RansEvmKEpsilonKCrossWindStabilized2D3N");
...
ModelPart& RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_SetUp(Model& rModel)
{
    ModelPart& r_model_part = EvmKEpsilonHighReTestUtilities::RansEvmKEpsilonEpsilon2D3N_SetUp(
        rModel, "RansEvmKEpsilonEpsilonCrossWindStabilized2D3N");
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKCrossWindStabilized2D3N_EquationIdVector, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKCrossWindStabilized2D3N_SetUp(model);

    // Test:
    RansModellingApplicationTestUtilities::TestEquationIdVector<ModelPart::ElementsContainerType>(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKCrossWindStabilized2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKCrossWindStabilized2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKCrossWindStabilized2D3N_CalculateLocalSystem, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKCrossWindStabilized2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKCrossWindStabilized2D3N_CalculateRightHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKCrossWindStabilized2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKCrossWindStabilized2D3N_CalculateMassMatrix, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonKCrossWindStabilized2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonKCrossWindStabilized2D3N_CalculateDampingMatrix,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_EquationIdVector,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_SetUp(model);

    // Test:
    RansModellingApplicationTestUtilities::TestEquationIdVector<ModelPart::ElementsContainerType>(r_model_part);
}

KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_GetDofList, KratosRansFastSuite)
{
    // Setup:
    Model model;
    auto& r_model_part = RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_SetUp(model);
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_CalculateLocalSystem,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_CalculateRightHandSide,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_CalculateLocalVelocityContribution,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_CalculateMassMatrix,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
...
KRATOS_TEST_CASE_IN_SUITE(RansEvmKEpsilonEpsilonCrossWindStabilized2D3N_CalculateDampingMatrix,
                          KratosRansFastSuite)
{
    // Setup:
    Model model;
