...
class KRATOS_API(RANS_APPLICATION) RansVtkOutputProcess : public Process
{
public:
    ///@name Type Definitions
    ///@{
...
private:
    ...
    void ReplaceAll(std::string& rOutput,
...
inline std::ostream& operator<<(std::ostream& rOStream, const RansVtkOutputProcess& rThis);
