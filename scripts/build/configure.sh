...
export PYTHON_EXECUTABLE=${PYTHON_EXECUTABLE:-"C:/Users/jogou/AppData/Local/Programs/Python/Python37/python.exe"}
...
-DLAPACK_LIBRARIES="C:/msys64/mingw64/lib/liblapack.dll.a"                             \
-DBLAS_LIBRARIES="C:/msys64/mingw64/lib/libblas.dll.a"                                 \
-H"${KRATOS_SOURCE}"                                                                                \
